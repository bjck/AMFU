...
namespace patterns
{
    public abstract class AbstractOrderedItemset : AbstractItemset
    {
        
	public AbstractOrderedItemset() : base() {
	}
	 ...
	 */
	public override abstract int getAbsoluteSupport();
	 ...
	 */
	public override double getRelativeSupport(int nbObject) {
